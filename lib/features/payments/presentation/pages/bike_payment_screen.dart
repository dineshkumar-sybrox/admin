...
class BikePaymentScreen extends StatefulWidget {
  const BikePaymentScreen({super.key});

  @override
  State<BikePaymentScreen> createState() => _BikePaymentScreenState();
}

class _BikePaymentScreenState extends State<BikePaymentScreen> {
  @override
  Widget build(BuildContext context) {
    return AdminScaffold(
      title: 'Payment Management - Bike/Scooter',
