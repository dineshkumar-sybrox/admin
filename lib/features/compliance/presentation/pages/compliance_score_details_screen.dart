...
class ComplianceScoreDetailsScreen extends StatelessWidget {
  ComplianceScoreDetailsScreen({super.key});
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          SizedBox(height: 24),
          _buildBreakdownItem('Aadhar', 82, AppColors.cFFF59E0B),
          SizedBox(height: 24),
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          SizedBox(height: 32),
          _buildLegendItem('Expired Document', '75%', AppColors.cFFEF4444),
          SizedBox(height: 12),
